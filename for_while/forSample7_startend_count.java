 ...
 * 3.do ~ while
 */
public class forSample7_startend_count {
	
	public static void main(String[] args) { //3000
				
	//문제> 시작 숫자를 입력하고, 끝나는 숫자를 입력하여 홀수의 갯수를 구하여 출력하세요.
	// 1.for
		...
		System.out.println("홀수의 합은 " + oddsum + "이고, 갯수는 " + oddcount + "입니다."); 
		System.out.println("짝수의 합은 " + evensum + "이고, 갯수는 " + evencount + "입니다."); 
